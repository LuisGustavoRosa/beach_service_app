              ...
              children: [
                ...
                Row(
                  children: [
                    Observer(
                      builder: (_) => Visibility(
                        visible: controller.pedidoRealizado && controller.pedidoStore.statusPedido == EnumStatusPedido.EmAberto || controller.pedidoStore.statusPedido == EnumStatusPedido.Aceito,
                        child: Expanded(
